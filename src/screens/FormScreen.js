...
export default function ({ navigation }) {
  ...
  const procdata  =async () => {
    try {
      const response = await fetch('http://172.20.10.2:4000/api/procesos');
  ...
  useEffect(() => {
    var config = {
      method: 'get',
      url: "http://172.20.10.2:4000/api/procesos",
    };
  ...
  const uebdata  =async () => {
    try {
      const response = await fetch('http://172.20.10.2:4000/api/ueb');
      const json = await response.json();
      setData(json.ueb);
    } catch (error) {
      console.error(error);
  ...
  useEffect(() => {
    var config = {
      method: 'get',
      url: "http://172.20.10.2:4000/api/ueb",
    };
  ...
  const entidaddata  =async () => {
    try {
      const response = await fetch('http://172.20.10.2:4000/api/entidad');
      const json = await response.json();
  ...
  useEffect(() => {
    var config = {
      method: 'get',
      url: "http://172.20.10.2:4000/api/entidad",
    };
  ...
  const unidaddata  =async () => {
    try {
      const response = await fetch('http://172.20.10.2:4000/api/unidad');
      const json = await response.json();
      setData(json.unidad);
    } catch (error) {
      console.error(error);
  ...
  useEffect(() => {
    var config = {
      method: 'get',
      url: "http://172.20.10.2:4000/api/unidad",
    };
  ...
  const areadata  =async () => {
    try {
      const response = await fetch('http://172.20.10.2:4000/api/area');
      const json = await response.json();
      setData(json.area);
    } catch (error) {
      console.error(error);
  ...
  useEffect(() => {
    var config = {
      method: 'get',
      url: "http://172.20.10.2:4000/api/area",
    };
  ...
  const trabajadoresdata  =async () => {
    try {
      const response = await fetch('http://172.20.10.2:4000/api/trabajadores');
      const json = await response.json();
  ...
  useEffect(() => {
    var config = {
      method: 'get',
      url: "http://172.20.10.2:4000/api/trabajadores",
    };
